...
* ## :clipboard: [Blog](https://github.com/EduardoVillegas17/AASVILLEGAS/tree/main/Blog "Blog")
    ...
    * ### :hourglass_flowing_sand: [A2.3_Software Architectural Patterns](https://github.com/EduardoVillegas17/AASVILLEGAS/blob/main/Blog/A2.3_Software_Architectural_Patterns.md "A2.3 Software Architectural Patterns")
