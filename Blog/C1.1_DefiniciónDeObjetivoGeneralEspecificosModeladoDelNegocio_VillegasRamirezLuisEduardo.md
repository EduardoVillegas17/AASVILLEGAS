...
Crear una plataforma web donde los usuarios registrados puedan completar cursos y certificaciones, donde los evaluadores puedan consultar a los miembros y dar de alta nuevos cursos.

2. Especifique tres **objetivos específicos**, recordándose que deben ser medibles, cuantificables y logrables.

1) Capacitar a los empleados de una empresa en los cursos ofrecidos.

2) Registrar a la mayor cantidad posible de empleados en la plataforma.

3) Conseguir una mayor cantidad de empleados capacitado.
...
<p align="center">
    <img alt="Modelado de Negocio: Añadir un Curso" src="https://raw.githubusercontent.com/EduardoVillegas17/AASVILLEGAS/main/IMG/CursosYCertificaciones.png">
</p>
